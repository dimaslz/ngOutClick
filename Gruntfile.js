module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    html2js: {
      ...
      components: {
        ...
        src: [ '<%= app_files.ctpl %>' ],
        dest: '<%= build_dir %>/templates-components.js'
      }
    },
  ...
  grunt.registerTask( 'watch', [ 'build', 'karma:unit', 'connect:server', 'open:chrome', 'delta' ] );
  grunt.registerTask( 'watch2', [ 'build2', 'karma:unit', 'connect:server', 'delta' ] );
  ...
  //   'clean', 'html2js', 'jshint','copy:build_app_assets', 'copy:build_vendor_assets',
  //   'sass:build', 'concat:build_css', 'copy:build_appjs', 'copy:build_vendorjs', 'copy:build_vendorcss', 'index:build', 'karmaconfig',
  //   'karma:continuous'
  // ]);
  ...
  grunt.registerTask('build', [
    'clean', 'html2js', 'jshint', 'sass:build',
    'concat:build_css', 'copy:build_app_assets', 'copy:build_vendor_assets',
    'copy:build_appjs', 'copy:build_vendorjs', 'copy:build_vendorcss', 'index:build', 'karmaconfig', 'karma:continuous'
  ]);
